...
```{r, results="hide", eval=align, message=FALSE}
library(Rsubread)
...
```{r, message=FALSE, results="hide", eval=align}
library(Rsamtools)
...
```{r, eval=!align, results="hide", echo=FALSE, message=FALSE}
library(Rsamtools)
library(Rsubread)
...
```{r, eval=align, results = 'hide'}
indexBam(bam.files)
```

```{r, echo = FALSE, results = 'hide', eval=align}
# Cleaning up
unlink(all.fastq)
unlink(group.fastq)
...
```{r, eval=align, message=FALSE, results="hide"}
...
```{r, eval=align, echo = FALSE, results = 'hide'}
# Cleaning up
unlink(all.fastq)
unlink(temp.dir, recursive=TRUE)
unlink(temp.file)
