...
```{r killindex, echo=FALSE, results="hide", message=FALSE, eval=!biocbuild}
...
```{r normplot, fig.cap="**Figure 4:** Effect of non-linear normalization on the trended bias between two H3K9ac libraries. Log-fold changes for all windows are shown after normalization."}
...
```{r, ref.label="killindex", echo=FALSE, results="hide", message=FALSE, eval=!biocbuild}
```
