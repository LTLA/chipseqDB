...
```{r, echo=FALSE, results="hide"}
rm(list=setdiff(ls(), c("blacklist", "gax", "greg", "remap", "redownload", "keep.files", "core.loc"))) # Cleaning out to save memory
gc()
```
...
```{r, echo=FALSE, results="hide"}
rm(list=setdiff(ls(), c("remap", "redownload", "keep.files", "core.loc")))
gc()
```
