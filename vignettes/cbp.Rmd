...
date: "`r Sys.Date()`"
vignette: >
  %\VignetteIndexEntry{Differential binding of CBP in fibroblasts}
...
BAM files are downloaded using `r Biocpkg("chipseqDBData")` and cached for later use.
...
Separation of replicates on the first dimension is indicative of a systematic difference of size comparable to that between genotypes.
